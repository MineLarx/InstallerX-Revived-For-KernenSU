...
[![License: GPL v3](https://img.shields.io/badge/License-GPLv3-blue.svg)](https://www.gnu.org/licenses/gpl-3.0)[![Latest Release](https://img.shields.io/github/v/release/MineLarx/InstallerX-Revived-For-KernenSU?label=Stable)](https://github.com/MineLarx/InstallerX-Revived-For-KernenSU/releases/latest)[![Prerelease](https://img.shields.io/github/v/release/MineLarx/InstallerX-Revived-For-KernenSU?include_prereleases&label=Beta)](https://github.com/MineLarx/InstallerX-Revived-For-KernenSU/releases)

- This is a module fork after the [original project](https://github.com/wxxsfxyzm/InstallerX-Revived)
